...
export default function AutoCompleteCor({ onSelecionar, value, selecionado, dadosTurma }) {
    ...
    const handleChange = (e) => {
        ...
        if (valor.length >= 0) {
            ...
            const filtrados = dadosTurma.filter((t) => {


                a = removerAcentos(t.cor);
    ...
    return (
        <div style={{ position: "relative", width: "100%" }}>
            <input
                ...
                onFocus={() => setSugestoes(dadosTurma)}
