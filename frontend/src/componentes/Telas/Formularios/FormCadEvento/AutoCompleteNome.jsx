...
export default function AutoCompleteNome({ onSelecionar, value, selecionado, dadosFunc }) {
            ...
            {sugestoes.length > 0 && (
                <ul style={{
                    ...
                    {sugestoes.map((s, i) => (
                        ...
                        <span style={{ width: '50%' }}>{s.nome}</span>
